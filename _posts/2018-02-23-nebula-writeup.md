...
{% endraw %}
{% endhighlight %}
Kaynak kodu daha iyi anlayabilmek adına, programda bulunan bazı fonksiyonlara bakalım.
...
**int setresgid(gid_t rgid,gid_t egid,git_t sgid);** // çağırılan processin real,effective,saved  group-id 
